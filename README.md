...
# ნეირონული ქსელები
### Data exploration and preprocessing
NBeats, PatchTST და DLinear არის univariate მოდელები, ანუ არ იყენებენ ეგზოგენურ ცვლადებს, ამიტომ ბევრი პრეპროცესინგი მათ არ სჭირდებათ.

### N-BEATS
ამ მოდელის არქიტექტურა ქვემოთა სურათზეა მოცემული:
<img width="1562" height="978" alt="image" src="https://github.com/user-attachments/assets/eca8e24b-8f2f-4fbf-b220-135680d528da" />

NBEATS ნეურონულ ბაზაზეა დაფუძნებული, deep learning მოდელია, რომელსაც არ სჭირდება ეგზოგენური ცვლადები, არამედ ის დატის დეკომპოზიციას
აკეთებს 3 ტიპის ბლოკებად: 
1. ტრენდი: ბლოკი 1 - პოლინომიური ფიტით სწავლობს ზოგად ტრენდს: ზოგადი, დიდი დროის სკოუპი.
2. სეზონურობა: ბლოკი 2 - ფურიე სერიბის დახმარებით, ამოიცნობს სეზონურობას: უფრო მოკლე მონაკვეთის ტენდენციებს. მაგ. დღესასწაულების დროს გაყიდვების რაოდენობების სპაიკს.
3. რეზიდუალები (იდენტობის/გენერალური) - ბლოკი 3-N: სწავლობს დარჩენილ დატას - ანუ რაც ტრენდმა და სეზონურმა დეკომპოზიციამ ვერ ისწავლა.

თითოეული ბლოკი აკეთებს forecast-ს h (horizon) რაოდენობის დატაზე, ანუ მომავალი h კვირის შემდეგ ბლოკებში კონტრიბუციას, და backcast-ს.
ყოველ შემდეგ ბლოკზე მის backcast-ს აკლებ, რათა წინა ბლოკის მიერ უკვე ამოცნობილი პატერნები აღარ ისწავლოს შემდეგმა ბლოკმა.
ბლოკების მიერ გაკეთებული forecast-ები კი ერთიანდება საბოლოო forecast-ის მისაღებად, ანუ წინა n ბლოკის აკეთებს მიმდინარე კვირის ფასის დადგენას.
...
მიღებული 2 კომპონენტის გაერთიანებით იღებს აუთფუთს. მიუხედავად მისი სიმარტივისა, ის ბევრ ამოცანაში საკმაოდ კარგ შედეგს დებს.
მასაც nbeats-ის მსგავსი პარამეტრები გააჩნია. მოდელი გარკვეული ზომის ფანჯრის (კვირების რაოდენობის) მცოცავ საშუალოებს იყენებს სეზონურობისა და ტრენდის ამოსაცნობად,
ანუ ზუსტად იმ ლოგიკას იყენებს, რითაც rolling_windows lag ცვლადები დავაგენერირეთ ზემოთ. ქვემოთ მოცემულია მოდელის არქიტექტურის სურათი.
<img width="1982" height="796" alt="image" src="https://github.com/user-attachments/assets/de5ecb19-e6bd-4155-b4e0-2e17d828c29e" />

ტრენინგისას დავატუნინგეთ შემდეგი ცვლადები - input_size, h, moving_avg_window, loss, scaler_type, learning_rate, max_steps.
ამ პარამეტრების ტუნინგიდან თითქმის მთელი გავლენა პირველმა 3-მა იქონია, სავარაუდოდ იმიტომ, რომ ოვერფიტზე ისედაც არ გადიოდა მოდელი.

საბოოო საუკეთესო მოდელის პარამეტრები:
1. input_size = 52 - წინა რამდენი კვირა იყოს გათვალისწინებული ახალი forecast-ისთვის
2. h = 40 - ჰორიზონი - მომდევნო რამდენ კვირაზე გაკეთდეს forecast
3. moving_avg_window = ["identity","trend","seasonality"] - ბლოკების ტიპები
4. loss = [3,3,3] - სტაკებში ბლოკების რაოდენობა
5. scaler_type = 2 - კოსინუ-სინუს წყვილების რაოდენობა სეზონურობისთვის
...
ქვემოთა პლოტებზეა მოცემული მათი ეფექტი ტრენინგისას ვალიდაციაზე.
<img width="704" height="547" alt="image" src="https://github.com/user-attachments/assets/59d05abe-64e8-475a-b711-e6236c650ced" />
